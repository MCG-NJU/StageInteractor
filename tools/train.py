...
def main():
    ...
    #if digit_version(TORCH_VERSION) > digit_version('1.7.1') and cfg.optimizer['type'] == 'AdamW':
    if cfg.optimizer['type'] == 'AdamW':
        print('Change Optimizer: MyAdamW')
        cfg.optimizer['type'] = 'MyAdamW' 
    ...
    save_checkpoint(model, cfg.work_dir+'/init_weights.pth') ###!!!
