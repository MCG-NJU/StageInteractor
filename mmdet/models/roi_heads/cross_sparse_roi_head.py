...
class CrossSparseRoIHead(CascadeRoIHead):
    ...
    def __init__(self,
        ...
        super(CrossSparseRoIHead, self).__init__(
            num_stages,
            stage_loss_weights,
    ...
    def _bbox_forward(self, stage, x, rois, object_feats, img_metas, dy_filter_list):
        ...
        bbox_feats = bbox_roi_extractor(x[:bbox_roi_extractor.num_inputs],
                                        rois)
        cls_score, bbox_pred, object_feats, dy_filter_list = bbox_head(bbox_feats, object_feats, dy_filter_list)
    ...
    def forward_train(self,
        ...
        for stage in range(self.num_stages):
            ...
            dy_filter_list = bbox_results['dy_filter_list']
            ori_assign_results = []
            for i in range(num_imgs):
                ...
                ori_assign_results.append(assign_result)
            
            gt2predid_in_all, pred2gtid_in_fg = \
    ...
    def get_query2gt_onehot_mat(self, assign_result_list):
        ...
        return gt2predid_in_all, pred2gtid_in_fg