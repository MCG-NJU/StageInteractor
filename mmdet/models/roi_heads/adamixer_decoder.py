...
class AdaMixerDecoder(CascadeRoIHead):
    ...
    def _bbox_forward(self, stage, x, xyzr, object_feats, img_metas):
        ...
        cls_score, delta_xyzr, object_feats = bbox_head(x, xyzr,
                                                        object_feats,
    ...
    def forward_train(self,
        ...
        num_imgs = len(img_metas)
        num_proposals = proposal_xyzrs.size(1)
        ...
        for stage in range(self.num_stages):
            bbox_results = self._bbox_forward(stage, x, xyzr, object_feats,
                                              img_metas)
    ...
    def forward_dummy(self, x, proposal_xyzrs,
