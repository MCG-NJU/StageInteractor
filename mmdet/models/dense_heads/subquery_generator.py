...
class SubInitialQueryGenerator(BaseModule):
    """
    ...
    def __init__(self,
        ...
        super(SubInitialQueryGenerator, self).__init__(init_cfg)
    ...
    def _init_layers(self):
        ...
        init_proposal_bboxes = self.init_content_features.weight.new_zeros(self.num_query, 4)
        self.register_buffer('init_proposal_bboxes', init_proposal_bboxes)
        
        

    def init_weights(self):
        super(SubInitialQueryGenerator, self).init_weights()
        self.init_proposal_bboxes[:, :2] = 0.5
        self.init_proposal_bboxes[:, 2:] = 1.
